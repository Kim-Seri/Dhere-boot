	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<div class="row p-5" id="header">
			...
			<div class="col justify-content-end d-flex align-items-center">
				...
				<a href="notice" class="text-decoration-none text-white" id="header_menu"
					onclick="location.href='notice'">Notice</a>
			    ...
			    </c:choose>" id="login_menu" tabindex="0" data-bs-html="true" data-bs-placement="bottom"
					data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="<c:choose>
							        <c:when test='${not empty sessionScope.member}'>
							    ...
							    </c:choose>" data-bs-content="<c:choose>
