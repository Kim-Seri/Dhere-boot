...
<div class="col-auto">
	...
	<div class="col justify-content-center" id="infobox">
		<div class="infoTab_box">
			<button type="button" class="btn btn-primary infoTab_btn" onclick="setActiveButton(this)">회원정보</button>
			<button type="button" class="infoTab_btnx" onclick="setActiveButton(this); location.href='${pageContext.request.contextPath}/mypageUpdateProcess'">회원정보수정</button>
			<button type="button" class="infoTab_btnx" onclick="setActiveButton(this); location.href='inquiryWrite'">1:1문의하기</button>
