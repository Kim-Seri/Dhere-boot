...
<script src="resources/js/findIdPass.js"></script>
	...
	<div class="row mb-3" style="margin-top: 100px">
        <div class="col text-center">
            <img src="resources/images/findId.png">
        </div>
    </div>
	<div class="row">
	...
	<div class="row mb-3" style="width: 600px; margin: 0 auto;">
		<div class="col rounded-3" style="border: 5px solid rgb(56, 96, 255)">
			<form class="my-5" name="findIdForm" id="findIdForm" action="findIdForm" method="post">
				<div class="row my-3">
					<div class="col-3 text-end">
						<label for="name" class="form-label" style="font-size: 20px; font-weight: bold">이름</label>
					</div>
					<div class="col">
						<input type="text" class="form-control rounded-3" name="findIdName" id="findIdName" style="border: 5px solid rgb(56, 96, 255); width: 250px">
					</div>
				</div>
				<div class="row">
					<div class="col-3 text-end">
					...
					<div class="col">
						<input type="text" class="form-control rounded-3" name="findIdPhone" id="findIdPhone" style="border: 5px solid rgb(56, 96, 255); width: 250px">
					</div>
					<div class="col">
						<input type="button" class="btn rounded-3" id="findIdSendBtn" value="인증번호 발송" 
				...
				<div class="row my-3">
					...
					<div class="col">
						<input type="text" class="form-control rounded-3" name="findIdChekch" id="findIdChekch" style="border: 5px solid rgb(56, 96, 255); width: 250px">
					</div>
					<div class="col">
						<input type="button" class="btn rounded-3" id="findIdChekchBtn" value="확인" 
